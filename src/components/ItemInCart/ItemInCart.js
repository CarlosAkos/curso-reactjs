    ...
    return(
        <div className="ItemInCartGrid">
            <div className="RemoveProduct">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3 pointerTrash" viewBox="0 0 16 16" onClick={()=>removeFromCart(product.id)}>
